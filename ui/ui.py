...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.shortcut_min_action = QAction(MainWindow)
        self.shortcut_min_action.setObjectName(u"shortcut_min_action")
        self.shortcut_equal_action = QAction(MainWindow)
        self.shortcut_equal_action.setObjectName(u"shortcut_equal_action")
        self.shortcut_add_action = QAction(MainWindow)
        self.shortcut_add_action.setObjectName(u"shortcut_add_action")
        ...
        self.menu_2.addAction(self.shortcut_min_action)
        self.menu_2.addAction(self.shortcut_equal_action)
        self.menu_2.addAction(self.shortcut_add_action)
        self.menu_2.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.shortcut_min_action.setText(QCoreApplication.translate("MainWindow", u"\u5feb\u6377\u952e-", None))
#if QT_CONFIG(shortcut)
        self.shortcut_min_action.setShortcut(QCoreApplication.translate("MainWindow", u"-", None))
#endif // QT_CONFIG(shortcut)
        self.shortcut_equal_action.setText(QCoreApplication.translate("MainWindow", u"\u5feb\u6377\u952e=", None))
#if QT_CONFIG(shortcut)
        self.shortcut_equal_action.setShortcut(QCoreApplication.translate("MainWindow", u"=", None))
#endif // QT_CONFIG(shortcut)
        self.shortcut_add_action.setText(QCoreApplication.translate("MainWindow", u"\u5feb\u6377\u952e+", None))
#if QT_CONFIG(shortcut)
        self.shortcut_add_action.setShortcut(QCoreApplication.translate("MainWindow", u"+", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.unit_dir_action.setText(QCoreApplication.translate("MainWindow", u"\u5355\u4f4d\u6570\u636e", None))
#if QT_CONFIG(shortcut)
        self.unit_dir_action.setShortcut(QCoreApplication.translate("MainWindow", u"F2", None))
#endif // QT_CONFIG(shortcut)
        self.heroes_dir_action.setText(QCoreApplication.translate("MainWindow", u"\u82f1\u96c4\u6570\u636e", None))
#if QT_CONFIG(shortcut)
        ...
        self.menu_7.setTitle(QCoreApplication.translate("MainWindow", u"\u8def\u5f84", None))
    # retranslateUi
